...
const app = getApp();
const { tencentMapKey } = app.globalData;
...
Page({
  ...
  selectCounty: function () {
    ...
    const that = this;
    wx.request({
      url: `https://apis.map.qq.com/ws/district/v1/getchildren?&id=${code}&key=${tencentMapKey}`,
      success: function (res) {
        ...
        console.log("请求区县成功" + `https://apis.map.qq.com/ws/district/v1/getchildren?&id=${code}&key=${tencentMapKey}`);
        // console.log(res)
      },
      fail: function () {
